...
export function Flex_17de8d4574febb8b57437cee557f248c () {
  ...
  {Object.entries(reflex___state____state__defimoney_monitor___views___color_picker____color_picker_state.primary_color_options).map((color, index_e1ea0b91751523a1) => (
  <RadixThemesTooltip content={color.at(0)} key={index_e1ea0b91751523a1}>
...
export function Theme_2ad6acba1d56658302b221cedfc8ab27 () {
  const reflex___state____state__defimoney_monitor___templates___template____theme_state = useContext(StateContexts.reflex___state____state__defimoney_monitor___templates___template____theme_state)
  ...
  <Flex_17de8d4574febb8b57437cee557f248c/>
</RadixThemesFlex>
  <RadixThemesFlex align={`start`} className={`rx-Stack`} css={{"width": "100%"}} direction={`column`} gap={`4`}>
  <RadixThemesFlex align={`center`} className={`rx-Stack`} direction={`row`} gap={`3`}>
  ...
  <Flex_365f76bd3139134832d58e2c1f23c536/>
</RadixThemesFlex>
  <Fragment>
...
export function Flex_365f76bd3139134832d58e2c1f23c536 () {
  const reflex___state____state__defimoney_monitor___views___color_picker____color_picker_state = useContext(StateContexts.reflex___state____state__defimoney_monitor___views___color_picker____color_picker_state)
  const [addEvents, connectErrors] = useContext(EventLoopContext);
  const reflex___state____state__defimoney_monitor___templates___template____theme_state = useContext(StateContexts.reflex___state____state__defimoney_monitor___templates___template____theme_state)
  ...
  return (
    <RadixThemesFlex css={{"width": "100%", "maxWidth": "40rem", "@media screen and (min-width: 0)": {"gap": "15px"}, "@media screen and (min-width: 30em)": {"gap": "15px"}, "@media screen and (min-width: 48em)": {"gap": "20px"}}} wrap={`wrap`}>
  {Object.entries(reflex___state____state__defimoney_monitor___views___color_picker____color_picker_state.secondary_color_options).map((colors, index_3778c9d8c6ee6051) => (
  <RadixThemesTooltip content={colors.at(0)} key={index_3778c9d8c6ee6051}>
...
export default function Component() {
  ...
  <Theme_2ad6acba1d56658302b221cedfc8ab27/>
  <NextHead>
  <title>
  {`Settings`}
</title>
