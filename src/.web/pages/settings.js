...
export function Flex_433dedfc75f11c2e631608c95a48256f () {
  ...
  {Object.entries(reflex___state____state__defimoney_monitor___views___color_picker____color_picker_state.secondary_color_options).map((colors, index_84f1ef1f6d3cc339) => (
  <RadixThemesTooltip content={colors.at(0)} key={index_84f1ef1f6d3cc339}>
...
export function Theme_06e093ba79b6f30e2a7969d8ff49800f () {
  const reflex___state____state__defimoney_monitor___templates___template____theme_state = useContext(StateContexts.reflex___state____state__defimoney_monitor___templates___template____theme_state)
  ...
  <Flex_b7d1278460ffa563585db61df843161f/>
</RadixThemesFlex>
  <RadixThemesFlex align={`start`} className={`rx-Stack`} css={{"width": "100%"}} direction={`column`} gap={`4`}>
  <RadixThemesFlex align={`center`} className={`rx-Stack`} direction={`row`} gap={`3`}>
  ...
  <Flex_433dedfc75f11c2e631608c95a48256f/>
</RadixThemesFlex>
  <Fragment>
...
export function Flex_b7d1278460ffa563585db61df843161f () {
  const reflex___state____state__defimoney_monitor___views___color_picker____color_picker_state = useContext(StateContexts.reflex___state____state__defimoney_monitor___views___color_picker____color_picker_state)
  const [addEvents, connectErrors] = useContext(EventLoopContext);
  const reflex___state____state__defimoney_monitor___templates___template____theme_state = useContext(StateContexts.reflex___state____state__defimoney_monitor___templates___template____theme_state)
  ...
  return (
    <RadixThemesFlex css={{"width": "100%", "maxWidth": "40rem", "@media screen and (min-width: 0)": {"gap": "15px"}, "@media screen and (min-width: 30em)": {"gap": "15px"}, "@media screen and (min-width: 48em)": {"gap": "20px"}}} wrap={`wrap`}>
  {Object.entries(reflex___state____state__defimoney_monitor___views___color_picker____color_picker_state.primary_color_options).map((color, index_64413e8440e7321e) => (
  <RadixThemesTooltip content={color.at(0)} key={index_64413e8440e7321e}>
...
export default function Component() {
  ...
  <Theme_06e093ba79b6f30e2a7969d8ff49800f/>
  <NextHead>
  <title>
  {`Settings`}
</title>
