...
export function Flex_ffbfadfdfd244d578ba88720d25a7f9e () {
  ...
  {Object.entries(reflex___state____state__defimoney_monitor___views___color_picker____color_picker_state.primary_color_options).map((color, index_1709bc4ef9184235) => (
  <RadixThemesTooltip content={color.at(0)} key={index_1709bc4ef9184235}>
...
export function Flex_53d385065cd7acee39f590bba99aac70 () {
  const reflex___state____state__defimoney_monitor___views___color_picker____color_picker_state = useContext(StateContexts.reflex___state____state__defimoney_monitor___views___color_picker____color_picker_state)
  const [addEvents, connectErrors] = useContext(EventLoopContext);
  const reflex___state____state__defimoney_monitor___templates___template____theme_state = useContext(StateContexts.reflex___state____state__defimoney_monitor___templates___template____theme_state)
  ...
  return (
    <RadixThemesFlex css={{"width": "100%", "maxWidth": "40rem", "@media screen and (min-width: 0)": {"gap": "15px"}, "@media screen and (min-width: 30em)": {"gap": "15px"}, "@media screen and (min-width: 48em)": {"gap": "20px"}}} wrap={`wrap`}>
  {Object.entries(reflex___state____state__defimoney_monitor___views___color_picker____color_picker_state.secondary_color_options).map((colors, index_778c0cabb6ab023e) => (
  <RadixThemesTooltip content={colors.at(0)} key={index_778c0cabb6ab023e}>
...
export function Theme_70459eb0e588bc7a4afd20481b8e487f () {
  const reflex___state____state__defimoney_monitor___templates___template____theme_state = useContext(StateContexts.reflex___state____state__defimoney_monitor___templates___template____theme_state)
  ...
  <Flex_ffbfadfdfd244d578ba88720d25a7f9e/>
</RadixThemesFlex>
  <RadixThemesFlex align={`start`} className={`rx-Stack`} css={{"width": "100%"}} direction={`column`} gap={`4`}>
  <RadixThemesFlex align={`center`} className={`rx-Stack`} direction={`row`} gap={`3`}>
  ...
  <Flex_53d385065cd7acee39f590bba99aac70/>
</RadixThemesFlex>
  <Fragment>
...
export default function Component() {
  ...
  <Theme_70459eb0e588bc7a4afd20481b8e487f/>
  <NextHead>
  <title>
  {`Settings`}
</title>
